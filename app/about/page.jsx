  ...
  return (
    <>
      <section className="w-full bg-about-background  bg-cover -mt-28 lg:-mt-36 py-32 lg:pt-52 lg:pb-28 text-center tracking-wide">
        <FadeAnimator y={0} x={100}>
          ...
          >
            ...
            into reality. You envision it, we build it into a smart
            user-friendly solution. Quality and satisfaction of our clients is
            our outmost highest priority.
          </p>
        </FadeAnimator>
      </section>
      <section className="mt-10 w-full lg:w-[80%] max-w-[1350px] bg-light m-auto  p-8 lg:p-8">
        <FadeAnimator y={0} x={-100}>
          ...
          <p className={`text-xl mt-6 ${raleway.className}`}>
            We are a US based software company. We build solutions tailored to
            the needs of our clients based on latest technologies to reach your
            desired goal with a proper strategy.
          </p>
          <p className={`text-xl mt-6 ${raleway.className}`}>
            For businesses looking to reach new milestones, our talented team is
            dedicated to help you through an efficient delivery oriented and
            agile process.
          </p>
        </FadeAnimator>
      </section>
        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/4  flex lg:block   ">
            ...
            <div className="w-3/4 flex-grow pb-4 lg:pb-0 lg:w-auto  about-number-img-first-desc">
              <FadeAnimator y={100} x={0}>
                <h4 className="text-2xl font-semibold lg:pr-12 text-primary mt-6">
                  Project Kickoff
                </h4>
                ...
                >
                  Regardless of whether you need to craft an idea for a
                  completely new product or evaluate the quality of an already
                  existing one - we&apos;re here to help you.
                </p>
              </FadeAnimator>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/4  flex lg:block  ">
            ...
            <div className="w-3/4 flex-grow pb-4 lg:pb-0 lg:w-auto ">
              <FadeAnimator y={100} x={0}>
                <h4 className="text-2xl font-semibold lg:px-6 text-primary mt-6">
          ...
          <div className="w-full lg:w-1/4  flex lg:block  ">
            ...
            <div className="w-3/4 flex-grow pb-4 lg:pb-0 lg:w-auto ">
              <FadeAnimator y={100} x={0}>
                <h4 className="text-2xl font-semibold lg:pl-12 text-primary mt-6">
                  Development Process
                </h4>
      ...
      <section className="w-full bg-secondary text-center ">
        <FadeAnimator y={100} x={0}>
          <h2 className="text-4xl font-bold text-white w-full lg:w-[80%] max-w-[1350px] m-auto  p-8 lg:p-8">
            OUR TEAM
          </h2>
          <p className="text-xl text-white max-w-[1350px] w-full lg:w-[80%] m-auto mt-4  p-8 lg:p-8">
            On the clock, we’re technology experts and leaders that bring
            energy, passion, and knowledge to every project. Off the clock,
            we’re an eclectic bunch of foodies, music buffs, artists, sports
            fanatics, karaoke pros, and outdoor enthusiasts.
          </p>
        </FadeAnimator>
      </section>
      <section className="w-full  p-8 pb-8 lg:p-16 text-center">
        <FadeAnimator y={0} x={100}>
          ...
          <p className={`text-xl mt-3 mb-6 ${raleway.className}`}>
            Head on over to our careers page and show us what you&apos;re made
            of!
          </p>
          <Link
            href="/careers"
      ...
      <section className="w-full  p-8 pb-s8 lg:p-16 ">
